...
RSpec.describe Admin::MenusController, type: :controller do
  include_examples 'unauthenticated', actions: %i[index show new create edit update]
  include_examples 'authorized_as_client', actions: %i[index show new create edit update]

  context 'authorized_as_admin' do
