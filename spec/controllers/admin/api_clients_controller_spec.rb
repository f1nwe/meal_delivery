...
RSpec.describe Admin::ApiClientsController, type: :controller do
  include_examples 'unauthenticated', actions: %i[index new create edit update destroy]
  include_examples 'authorized_as_client', actions: %i[index new create edit update destroy]
